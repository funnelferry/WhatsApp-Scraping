...
def downloadImages(contact,driver):
    ...
    media = driver.find_elements_by_xpath('//*[@id="app"]/div/div/div[2]/div[3]/span/div/span/div/div/section/div[3]/div[1]/div/div/div[1]/span')
    print(media)
    media[0].click()
    ...
    while(True):
        ...
        #Load Images
        images = driver.find_elements_by_xpath('//*[@id="app"]/div/div/div[2]/div[3]/span/div/span/div/div[2]/span/div/div/div/*')
        imgCount = len(images)
